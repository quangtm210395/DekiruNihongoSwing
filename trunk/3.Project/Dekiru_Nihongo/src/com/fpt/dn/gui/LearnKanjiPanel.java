 ...
 * @author WindzLord
 */
public class LearnKanjiPanel extends javax.swing.JFrame {

    /**
     * Creates new form LearnKanjiPanel
     *
     * @param kanji
     */
    public LearnKanjiPanel(DNObject kanji) {
        initComponents();
        labelKey.setText(kanji.getKey().substring(5));
        textAreaValue.setText(kanji.getValue());
    }
    ...
    private void initComponents() {
        ...
        labelTitle.setText("    Kanji Information    ");
